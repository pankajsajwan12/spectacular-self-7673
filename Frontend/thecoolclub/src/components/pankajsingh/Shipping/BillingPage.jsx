...
const BillingPage = () => {
  ...
  const user_name = useSelector((store) => store.Auth.currentUser);
  ...
  const userDetails = [
    {
      user_address:
        "Bhojgan laubaj garur bageshwar uttrakhand Bhojgan, KY 39201",
        ...
        <div className="shipping_page">
          <div className="shipping_page_right_main">
            ...
            <div className="shipping_page_right_main_shippingAddress">
              <Heading textAlign="left" ml="1rem" mt="2.3rem">
                {" "}
                CONTACT INFORMATION{" "}
              </Heading>
                  ...
                  <AccordionPanel>
                    <FormControl isRequired>
                      ...
                      <Text fontSize="13px" textAlign="justify">
                        Only one promotion code can be applied per order. You
                        can submit a different code by entering it in the field
                        above and clicking apply.
                      </Text>
                    </FormControl>
                  </AccordionPanel>
                </AccordionItem>
                ...
                <AccordionItem>
                  ...
                  <AccordionPanel>
                    <FormControl isRequired>
                      ...
                      <Text mt="0.6rem">
                        Up to 2 Gift Cards can be applied per order.
                      </Text>
                    </FormControl>
                  </AccordionPanel>
                </AccordionItem>
            ...
            <div className="payment_method">
              ...
              <Box display="flex" mt="0.5rem">
                <input name="paymentRadios" type="radio" />
          ...
          <div className="shipping_page_left_main">
            ...
            <Box display="flex" className="border_product">
              <Box mt="1rem">
                <img
                  src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.219/dw/image/v2/BBDL_PRD/on/demandware.static/-/Sites-master-catalog/default/dwb15abfdd/hires/026573586.jpg?sw=177&yocs=o_s_"
                  alt=""
            ...
            <Box display="flex">
              <Box width="60%" textAlign="left" ml="1.5rem">
                ...
                <Text mt="1.5rem">
                  {" "}
                  ESTIMATED SHIPPING & <br /> HANDLING - Standart
                </Text>
            ...
            <Box width="60%" textAlign="justify" ml="1.5rem" mb="1rem">
              {" "}
